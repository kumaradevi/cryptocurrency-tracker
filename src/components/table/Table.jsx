        ...
        <table className='w-[90%] mx-auto'>
            ...
            <tbody >
               {coins&& coins.slice(0,10).map((coin)=>( <tr className='content'>
                    ...
                    <td className={`${coin.price_change_percentage_1h > 0 ? "text-green-400": "text-red-400"}  text-sm flex gap-2 items-center font-medium`}>{coin.price_change_percentage_1h > 0 ? <BiSolidUpArrow size={11}/> : <BiSolidDownArrow size={11}/>} {coin.price_change_percentage_1h_in_currency.toFixed(2)} %</td>
